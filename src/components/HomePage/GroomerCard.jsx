...
return (
    <div className="container d-flex justify-content-center align-items-center">
      <div className="row d-flex justify-content-center">
        <div class="card card_1 col-12 col-md-6 col-lg-4 col-xl-2">
          ...
          <div class="card-body">
            <p class="card-text">
            Crafting tailored styles with precision, passion, and unparalleled expertise daily.
            </p>
          </div>
        </div>
        <div class="card card_2 col-12 col-md-6 col-lg-4 col-xl-6">
          <img
        ...
        <div class="card card_3 col-12 col-md-6 col-lg-4 col-xl-2">
          <img
          ...
          <div class="card-body">
            ...
            Complete your grooming routine with our platform connecting you to top-notch salons and barbershops.
            </p>
          </div>
        </div>
      </div>{" "}
